...
Ownership changes, through acquisitions, mergers, and sales, are common across many sectors of the economy. Industry data suggest that hundreds of thousands of U.S. businesses change ownership annually (CITE?), and survey evidence indicates that a large share of small business owners expect to exit within the next decade (CITE?). Ownership transitions are also prevalent in healthcare. The Centers for Medicare and Medicaid Services (CMS) reports that 347 ownership changes among hospitals and more than 3,000 among skilled nursing facilities between 2016 and 2021. These ownership changes can have a significant effect on the patients who are served by these facilities. This is the case because they may shift managerial objectives and operational practices, especially staffing, without changing the services a facility provides. In nursing homes care is  very dependent on labor and quality depends on inputs like nurse staffing. With staffing as a primary input into care, this paper asks: How do ownership changes affect nurse staffing levels in U.S. nursing homes, and do effects differ by chain affiliation and before versus after the COVID-19 pandemic?

Nursing homes provide a particularly important setting in which to study the consequences of ownership changes. They serve a medically vulnerable population, operate under heavy regulatory oversight, and are a persistent focus of policy concern in long-term care markets. Because facilities continue to care for the same residents before and after a transition, ownership changes can reshape care delivery through internal operational decisions even when the set of providers in a market is unchanged.

Care in nursing homes is highly labor-intensive and relies heavily on skilled and semi-skilled nursing labor. Nursing staff time and skill mix (the share of nurse staff types) determine the amount of clinical oversight and direct-care time residents receive, making staffing a central input into the production of care. Nursing labor is also among the largest operating expenses for nursing homes, so staffing is a natural margin along which facilities may adjust in response to changes in financial constraints, management practices, or organizational structure.

Staffing is directly relevant for patient welfare because nurse labor affects the quality of care delivered. A large body of evidence links higher nurse staffing, particularly registered nurse staffing, to improved patient outcomes, including lower mortality \citep{udina_et_al_2025}, and recent work documents that shortfalls in nursing staff can worsen inpatient outcomes \citep{dallora_et_al_2022,kelly_et_al_2026}. In nursing homes, where residents require continuous assistance and clinical monitoring, staffing shortfalls can plausibly translate into poorer care processes, higher risk of adverse events, and weaker regulatory performance. As a result, staffing is a natural channel through which ownership changes may affect the quality of care that residents receive.

There are two types of ownership changes that can occur within any entity. The first is ownership changes that reallocate assets across firms in a way that changes the set of providers within a market. These ownership changes are driven by mergers and acquisitions, and private equity. There is extensive research that focuses on this type of ownership change, motivated by concerns over market power, competition, consumer welfare, and antitrust. With growing concerns over private equity, much of this literature focuses on mergers and acquisitions and how they affect prices, costs, and market structure, finding that they can substantially reshape competitive conditions across many different industries. This research has generated important insights into these areas and has played a central role in informing antitrust policy.

However, the second type of ownership changes involves a transfer of control of an existing participant, leaving the set of providers in the market largely unchanged while potentially reshaping managerial objectives and operational practices within the firm. These ownership changes do not change market concentration or participation. In these cases, the primary effects of ownership change may operate through internal decisions rather than through changes in market structure or price competition. As a result, while existing research provides a strong framework for understanding the competitive effects of ownership changes, important questions remain about the non-price effects of ownership changes do not alter the underlying number of market participants.

From a conceptual standpoint, the staffing response to ownership change is ambiguous. New owners may face tighter budgets, higher debt service, or pressure to reduce operating costs, which can create incentives to cut staffing. At the same time, owners may invest in staffing to improve quality, ensure regulatory compliance, or protect reputation. Because revenues are relatively rigid in the short run for many nursing homes, staffing decisions reflect a cost--quality tradeoff: increasing staffing raises costs but may improve quality, while reducing staffing lowers costs but can increase compliance risk and worsen care \citep{cms_staffing_study_2023}.
