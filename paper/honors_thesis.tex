...
\begin{frontmatter}
\title{Labor Input Responses to Ownership Changes: Evidence from U.S. Nursing Homes}
\author[miami]{Joseph White\corref{cor1}}
\ead{whitejf@miamioh.edu}

% \author[miami]{John Bowblis\corref{cor2}}
% \ead{bowblijr@miamioh.edu}

\address[miami]{Miami University, Oxford, OH, USA}
...
Ownership generally $\rightarrow$ Non-price/labor outcomes $\rightarrow$ Healthcare $\rightarrow$ Nursing homes $\rightarrow$ My paper and contributions. within the healtchare theres been a lot of ownership changes, people are concenred about private equity, etc... they come in and cut quality. Patients are vulernable and dependent on staff, but what people havent looked into is ownership more generally. If staffing is so important what decisions do they make 
