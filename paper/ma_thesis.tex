...
\todo[inline, color = pastelyellow]{I somewhat modeled this intro after "Impact of primary care market mergers on quality: Evidence from the English NHS" by Yuan Lyu and Zhaocheng Zhang}

Ownership changes are a central feature of health care markets. Hospitals, physician practices, nursing homes, dialysis clinics, and other providers are frequently acquired, reorganized, merged, or transferred to new owners. These transitions have increased concern by policymakers, academics, and the public, especially as private equity firms, chains, and complex ownership structures have become more visible in health care. Yet private equity is only one form of ownership change. Providers may also change ownership because of financial distress, corporate restructuring, regulation, chain expansion, or the exit of smaller independent operators. These transactions raise a broader question: when control of an existing health care provider changes hands, how do the inputs, routines, and measured quality of care change?
...
\todo[color = pastelyellow]{this paragraph feels a little awkward, but I know I have to address this}
...
\todo[inline, color=pastelyellow]{Possibly a paragraph on how we contribute to the measurement of ownership changes}
...
\todo[inline, color = pastelyellow]{Still working on a paragraph about the quality metrics. I also include some background on them in my data section}
...
In this subgroup analysis, we estimate the same specifications as in equations~\ref{eq:event-study-staffing} and~\ref{eq:twfe-post}, maintaining consistent controls, fixed effects, and clustering. This analysis sheds light on whether the staffing consequences of ownership changes differ across pre-pandemic and pandemic-era labor market conditions.
